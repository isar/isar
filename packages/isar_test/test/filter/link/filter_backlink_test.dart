  ...
  group('Filter backlink', () {
    ...
    isarTest('.backlink()', () async {
      ...
      await qEqualSet(
        isar.targetModels
            .filter()
            .backlink((q) => q.nameEqualTo('source 2'))
            .tFindAll(),
        [target2],
      );
      ...
      await qEqualSet(
        isar.targetModels
            .filter()
            .backlink((q) => q.nameEqualTo('source 3'))
            .tFindAll(),
        [target3],
      );
      ...
      await qEqualSet(
        isar.targetModels
            .filter()
            .backlink((q) => q.nameEqualTo('source 5'))
            .tFindAll(),
        [],
      );
      ...
      await qEqualSet(
        isar.targetModels
            .filter()
            .backlink((q) => q.nameEqualTo('source 6'))
            .tFindAll(),
        [],
      );
    ...
    isarTest('.backlinkIsNull()', () async {
      await qEqualSet(
        isar.targetModels.filter().backlinkIsNull().tFindAll(),
        [target5, target6],
      );
